    ...
    useEffect(() => {
        const fetchStats = async () => {
            try {
                ...
                const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/stats/system`, {
                    headers: {
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-purple-400 font-bold">
                                    {loading ? '...' : formatNumber(stats.totalHospitals)}
                                </span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-gray-300">Available Units</span>
                                <span className="text-red-400 font-bold">
                                    {loading ? '...' : formatNumber(stats.availableUnits)}
                                </span>
                            </div>
                        </div>
                    </div>
